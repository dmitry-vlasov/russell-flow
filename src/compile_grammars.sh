...
flowcpp --batch lingo/pegcode/pegcompiler.flow -- flowparser=mptp/parse/file.flow flowparserast=mptp/parse/ast.flow file=mptp/parse/tptp.lingo prefix_rules=tptp
