...
public class Struct_MizTrmSRec extends Struct implements Field_numDetermined<Boolean>, Field_numValue<Struct_MizComplex>, Field_eqClass<Struct>, Field_superCluster<Struct_MizAttrColl> {
	...
	public Struct_MizTrmSRec(Struct a_term, boolean a_numDetermined, Struct_MizComplex a_numValue, Struct a_eqClass, Struct_Vector a_xTypClass, Struct_MizAttrColl a_superCluster) {
		f_term = a_term;
	...
	private static final String[] field_names = new String[] {
		"term", "numDetermined", "numValue", "eqClass", "xTypClass", "superCluster"
	};
	private static final RuntimeType[] field_types = new RuntimeType[] {
		RuntimeType.STRUCT, RuntimeType.BOOL, RuntimeType.STRUCT, RuntimeType.STRUCT, RuntimeType.STRUCT, RuntimeType.STRUCT
	};
	...
	public Object[] getFields() {
		return new Object[] {
			f_term, f_numDetermined, f_numValue, f_eqClass, f_xTypClass, f_superCluster
		};
	}
