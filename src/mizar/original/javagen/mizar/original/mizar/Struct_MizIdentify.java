...
public class Struct_MizIdentify extends Struct implements Field_onlyConstants<Boolean>, Field_equalsExpansionLevel<Integer>, Field_equalsExpand<Func3<Object[],Struct_MizIdentify, Integer, Struct>> {
	...
	public Struct_MizIdentify(Struct_MizCorrelEnv a_env, Struct_Vector a_sortedIdx, Struct_Vector a_numeric, boolean a_onlyConstants, int a_equalsExpansionLevel, Struct_Vector a_revReq, Func3<Object[],Struct_MizIdentify, Integer, Struct> a_equalsExpand, Struct_Vector a_reductions) {
		f_env = a_env;
	...
	private static final String[] field_names = new String[] {
		"env", "sortedIdx", "numeric", "onlyConstants", "equalsExpansionLevel", "revReq", "equalsExpand", "reductions"
	};
	private static final RuntimeType[] field_types = new RuntimeType[] {
		RuntimeType.STRUCT, RuntimeType.STRUCT, RuntimeType.STRUCT, RuntimeType.BOOL, RuntimeType.INT, RuntimeType.STRUCT, RuntimeType.UNKNOWN, RuntimeType.STRUCT
	};
	...
	public Object[] getFields() {
		return new Object[] {
			f_env, f_sortedIdx, f_numeric, f_onlyConstants, f_equalsExpansionLevel, f_revReq, f_equalsExpand, f_reductions
		};
	}
