...
# the repository under src/mizar/foundation/ — see src/mizar/foundation/README.md.
set -eu
BASE_DIR=$( cd "$( dirname "$0" )/../../.." && pwd -P )
MATH="${RUSSELL_MATH:-$HOME/dev/math}"
install -D -m 644 "$BASE_DIR/src/mizar/foundation/miz_aux.ru" "$MATH/mizar/miz_aux.ru"
echo "installed $MATH/mizar/miz_aux.ru from $BASE_DIR/src/mizar/foundation/miz_aux.ru"
